...
public class LinkedListClass<Key>{
	...
	public void makeOrderedList(LinkedListNode<Key> newNode) {
	
		LinkedListFunction<Key> tempNode;
		if (headNode == null || ((Integer) headNode.getKey())>=((Integer) newNode.getKey())) {
			newNode.setNextNode(headNode);
			headNode = newNode;
		} else {
			tempNode = headNode;
			while (tempNode.getNextNode() != null && ((Integer) newNode.getKey())>((Integer) tempNode.getKey())) {
				tempNode = tempNode.getNextNode();
